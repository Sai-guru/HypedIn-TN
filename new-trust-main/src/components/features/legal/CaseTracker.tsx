...
export default function CaseTracker() {
  ...
  const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || '/api/lcase';
  ...
  const fetchCases = async () => {
    ...
    try {
      const res = await safeFetch(`${API_BASE_URL}/cases`);
  ...
  const searchCases = async () => {
    ...
    try {
      ...
      const res = await safeFetch(`${API_BASE_URL}/cases/search?${searchParams}`);
