...
export default function DocumentGeneratorAdmin() {
  ...
  const [templates, setTemplates] = useState<DocumentTemplate[]>([
    {
      ...
      description:
        "Create a legally binding rental contract between landlord and tenant",
      usageCount: 342,
    ...
    },
    {
      ...
      title: "Affidavit",
      description:
        "Generate self-declaration, name change or income affidavits",
      usageCount: 278,
    ...
    },
    {
      ...
      description:
        "Create authorization documents for property or legal matters",
      usageCount: 156,
    ...
    const fetchData = async () => {
      try {
        const API_HOST = process.env.NEXT_PUBLIC_API_BASE_URL
          ...
          : "http://localhost:5000";
        const api = axios.create({ baseURL: `${API_HOST}/api/docu` });
        ...
        if (settingsRes.data) {
          ...
          console.warn("Received null settings data. Keeping defaults.");
        }
      } catch (error) {
        console.error("Error fetching data:", error);
        alert("Failed to load templates or settings.");
      }
    };
  ...
  const toggleTemplateStatus = async (id: string) => {
    try {
      const API_HOST = process.env.NEXT_PUBLIC_API_BASE_URL
        ...
        : "http://localhost:5000";
      const api = axios.create({ baseURL: `${API_HOST}/api/docu` });
      const res = await api.patch(`/templates/${id}/toggle-status`);
  ...
  const handleSaveTemplate = async () => {
    ...
    const newId = currentTemplate.title
      .toLowerCase()
      .replace(/\s+/g, "-")
      .replace(/[^a-z0-9-]/g, "");
  ...
  const averageUsage =
    templates.length > 0 ? Math.round(totalUsage / templates.length) : 0;
  const mostUsedTemplate = templates.reduce(
    (max, t) => (t.usageCount > max.usageCount ? t : max),
    templates[0] || { usageCount: 0, title: "None" }
  );
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Manage document templates and track usage
            </p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateTemplateField("title", e.target.value)
                    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateTemplateField("status", e.target.value)
                      }
                    >
              ...
              <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
                ...
                {templates.length === 0 ? (
                  ...
                  templates.map((template) => (
                    <div
                      key={template.id}
                      className="grid grid-cols-12 p-4 border-b hover:bg-gray-50 transition-colors"
                    >
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-purple-50 p-6 rounded-lg border border-purple-100">
                ...
                <div className="text-sm text-purple-600 mt-2">
                  Most used: {mostUsedTemplate.title}
                </div>
              </div>
            </div>
            ...
            {templates.length === 0 ? (
              <div className="text-gray-500 text-center py-4">
                No templates available for analysis
              </div>
            ) : (
              <div className="space-y-3">
                {templates
                  ...
                  .map((template) => {
                    const percentage =
                      totalUsage > 0
                        ? (template.usageCount / totalUsage) * 100
                        : 0;
                    return (
                      <div
                        key={template.id}
                      ...
                      >
                        <div
                          className="w-48 text-sm text-gray-600 truncate"
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateSetting("pdfQuality", e.target.value)
                      }
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateSetting("pageSize", e.target.value)
                      }
                    >
                      <option>A4</option>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateSetting("includeWatermark", e.target.checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateSetting("enablePreview", e.target.checked)
                      }
                    />
                  </div>
