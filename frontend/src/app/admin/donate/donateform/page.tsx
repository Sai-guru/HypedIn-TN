...
export default function AdminDonationFormPage() {
  ...
  const addDonationOption = () => {
    if (
      newDonationOption.amount &&
      newDonationOption.impact &&
      newDonationOption.icon
    ) {
      setFormConfig((prev) => ({
        ...prev,
        donationOptions: [
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Customize the donation form settings and options
          </p>
        </div>
      ...
      {isSaved && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center gap-3">
          ...
          <span className="text-green-800">
            Donation form configuration saved successfully!
          </span>
        </div>
      )}
              ...
              >
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      updateDonationOption(index, "enabled", e.target.checked)
                    }
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      value={option.amount}
                      onChange={(e) =>
                        updateDonationOption(index, "amount", e.target.value)
                      }
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      value={option.impact}
                      onChange={(e) =>
                        updateDonationOption(index, "impact", e.target.value)
                      }
                      className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                  <div className="flex items-end gap-2">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        value={option.icon}
                        onChange={(e) =>
                          updateDonationOption(index, "icon", e.target.value)
                        }
                        className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFormConfig((prev) => ({
                        ...prev,
                        customAmountEnabled: e.target.checked,
                      }))
                    }
                    className="w-4 h-4 text-blue-600"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFormConfig((prev) => ({
                        ...prev,
                        monthlyDonationEnabled: e.target.checked,
                      }))
                    }
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className="text-gray-700">
                    Enable monthly donation option
                  </span>
                </label>
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFormConfig((prev) => ({
                        ...prev,
                        anonymousDonationEnabled: e.target.checked,
                      }))
                    }
                    className="w-4 h-4 text-blue-600"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setFormConfig((prev) => ({
                        ...prev,
                        messageFieldEnabled: e.target.checked,
                      }))
                    }
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className="text-gray-700">
                    Enable message/note field
                  </span>
                </label>
              </div>
            </div>
                ...
                >
                  <div className="flex items-center gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) =>
                        updatePaymentMethod(key, "enabled", e.target.checked)
                      }
                      className="w-4 h-4 text-blue-600"
                    />
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        value={method.name}
                        onChange={(e) =>
                          updatePaymentMethod(key, "name", e.target.value)
                        }
                        className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
      ...
      {activeTab === "settings" && (
        <AdminCard className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-gray-500">
                  {formConfig.formSettings.currencySymbol}
                </span>
                <input
                  type="number"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Default Amount (for custom input)
              </label>
              <div className="flex items-center gap-2">
                <span className="text-gray-500">
                  {formConfig.formSettings.currencySymbol}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Changes to payment methods and currency settings may require
                  additional configuration in your payment gateway settings.
                  Please ensure your payment processors support the selected
                  options.
                </p>
              </div>
            </div>
