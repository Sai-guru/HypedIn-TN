...
export default function AdminVideoLectures() {
  ...
  const mockVideos: VideoLecture[] = [
    {
      ...
      category: "UPSC",
      description:
        "Comprehensive analysis of current affairs for UPSC preparation with monthly updates and key highlights.",
      duration: "2:45:30",
      views: 125000,
      rating: 4.8,
    ...
    },
    {
      ...
      category: "SSC",
      description:
        "Learn time-saving math shortcuts and tricks for SSC examinations with practice problems.",
      duration: "1:30:45",
      views: 89000,
      rating: 4.7,
      thumbnail: "/api/placeholder/400/300",
    ...
    },
    {
      ...
      category: "Banking",
      description:
        "Complete banking awareness course covering all banking concepts, RBI guidelines, and recent updates.",
      duration: "3:15:20",
      views: 0,
      rating: 0,
      thumbnail: "/api/placeholder/400/300",
  ...
  const mockLiveLectures: LiveLecture[] = [
    {
      ...
      category: "UPSC",
      description:
        "Interactive session discussing UPSC Mains strategy with live Q&A and doubt clearing.",
    ...
    },
    {
      ...
      category: "SSC",
      description:
        "Live problem-solving session for SSC CGL mathematics with real-time doubt clearing.",
    ...
    },
    {
      ...
      category: "Banking",
      description:
        "Weekly current affairs update specifically for banking examinations with key highlights.",
    ...
    },
    {
      ...
      category: "Programming",
      description:
        "Intensive live bootcamp covering Python web development with Django framework.",
  ...
  const filteredLiveLectures = mockLiveLectures.filter((lecture) => {
    ...
    const matchesStatus =
      selectedStatus === "all" || lecture.status === selectedStatus;
          ...
          <div className="p-4">
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center gap-1 text-sm text-gray-600">
                ...
                <span>
                  {lecture.attendees}/{lecture.maxAttendees} attendees
                </span>
              </div>
                  ...
                  <tr key={lecture.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        ...
                        <div
                          className={`px-2 py-1 text-xs font-medium rounded-full inline-block ${getLevelColor(
                            lecture.level
                          )}`}
                        >
                          {lecture.level}
                    ...
                    <td className="px-6 py-4">
                      <div className="text-gray-900">
                        {lecture.attendees}/{lecture.maxAttendees}
                      </div>
                      <div className="text-xs text-gray-500">
                        {Math.round(
                          (lecture.attendees / lecture.maxAttendees) * 100
                        )}
                        % capacity
                      </div>
                    </td>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Video & Live Lectures Management
              </h1>
              <p className="text-gray-600">
                Manage all video lectures, live sessions, and educational
                content
              </p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {
                        mockVideos.filter((v) => v.status === "Published")
                          .length
                      }
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-red-600">
                      {
                        mockLiveLectures.filter((l) => l.status === "Live")
                          .length
                      }
                    </p>
                  </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {formatViews(
                        mockLiveLectures.reduce(
                          (sum, l) => sum + l.attendees,
                          0
                        )
                      )}
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-600">
                      {
                        mockLiveLectures.filter((l) => l.status === "Scheduled")
                          .length
                      }
                    </p>
                  </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder={`Search ${
                  activeTab === "videos" ? "videos" : "live lectures"
                }, instructors, or tags...`}
                value={searchTerm}
            ...
            <div className="flex items-center gap-4">
              ...
              <select
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
                {(activeTab === "videos" ? statuses : liveStatuses).map(
                  (status) => (
