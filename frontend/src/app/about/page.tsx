          ...
          >
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-gray-700 mb-4">
                ...
                . Founded in 2015, our mission is to{" "}
                <span className="font-bold">
                  bring hope, resources, and opportunities
                </span>{" "}
                to those in need. Whether it's providing food, education,
                healthcare, or shelter, we are committed to creating a world
                where no one is left behind.
              </p>
              <p className="text-lg text-gray-700 mb-4">
                With a community of dedicated volunteers, donors, and
                changemakers, we have positively impacted{" "}
                <span className="font-bold">
                  over 100,000 lives across 50 cities and villages in India
                </span>
                .
              </p>
