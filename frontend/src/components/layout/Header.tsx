        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center group">
              <div className="mr-3">
                <img
                  src="https://2mtegaywr8.ucarecd.net/774e1d53-bdf2-4183-9f08-02397417708d/bst.jpg"
                  alt="Bharat Samartha Trust Logo"
              ...
              <div>
                <motion.span
                  className={`font-bold text-3xl ${
                    isScrolled ? "text-violet-600" : "text-white"
                ...
                <motion.div
                  className={`text-sm font-medium ${
                    isScrolled ? "text-violet-400" : "text-violet-200"
                  } transition-colors`}
