...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: "https", hostname: "picsum.photos" },
      { protocol: "http", hostname: "localhost" },
      { protocol: "https", hostname: "2mtegaywr8.ucarecd.net" },
    ],
  },
  ...
  async rewrites() {
    ...
    // 🚫 NO regex quantifiers (Turbopack-safe)
    let apiHost = raw.endsWith("/") ? raw.slice(0, -1) : raw;
    apiHost = apiHost.replace("/api", "");

    return [
      { source: "/api/admin/home/hero-section", destination: `${apiHost}/api/hero` },
      { source: "/api/admin/home/stats-section", destination: `${apiHost}/api/stat/stats` },
      { source: "/api/admin/home/events-section", destination: `${apiHost}/api` },
      { source: "/api/admin/home/daily-activities", destination: `${apiHost}/api/activities` },
      { source: "/api/admin/home/volunteer-opportunities", destination: `${apiHost}/api/volunteer-management` },
      { source: "/api/admin/home/impact-section", destination: `${apiHost}/api/impact` },
      { source: "/api/admin/home/featured-causes", destination: `${apiHost}/api/causes` },
      { source: "/api/admin/home/testimonials", destination: `${apiHost}/api/test` },
      { source: "/api/admin/home/call-to-action", destination: `${apiHost}/api/cta` },
      { source: "/api/admin/home/newsletter", destination: `${apiHost}/api/newsletter` },
      { source: "/api/:path*", destination: `${apiHost}/api/:path*` },
    ];
  },
};
